...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{Dataset-split-result.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{Final-accuracy-result-with-numbers-on-bars.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{OOV-analysis-result-with-numbers-on-bars.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{Top-10-mistake-types-with-numbers-on-bars.png}
...
sentences. These examples are written as a clean table rather than as a
screenshot.
