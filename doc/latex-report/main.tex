...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth, trim=0 0 14pt 0, clip]{resultImage/Dataset-split-result.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth, trim=0 0 13pt 0, clip]{resultImage/Final-accuracy-result-with-numbers-on-bars.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth, trim=0 0 13pt 0, clip]{resultImage/OOV-analysis-result-with-numbers-on-bars.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\linewidth]{resultImage/Top-10-mistake-types-with-numbers-on-bars.png}
