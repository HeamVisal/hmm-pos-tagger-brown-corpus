...
Laplace smoothing is applied to emissions, including the additional OOV
outcome in the emission vocabulary represented by $|V|$. It gives every
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth, trim=0 0 13pt 0, clip]{resultImage/Final-accuracy-result-with-numbers-on-bars.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth, trim=0 0 13pt 0, clip]{resultImage/OOV-analysis-result-with-numbers-on-bars.png}
